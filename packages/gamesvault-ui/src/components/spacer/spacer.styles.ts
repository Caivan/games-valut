...
const getSizeValue = (size: string) => {
  switch (size) {
    case 'xs':
      return css`${({ theme }) => theme.spacing.xs}`;
    case 'sm':
      return css`${({ theme }) => theme.spacing.sm}`;
    case 'md':
      return css`${({ theme }) => theme.spacing.md}`;
    case 'lg':
      return css`${({ theme }) => theme.spacing.lg}`;
    case 'xl':
      return css`${({ theme }) => theme.spacing.xl}`;
    default:
      return css`${({ theme }) => theme.spacing.md}`;
  }
};
